...
namespace AIIntegration.AI
{
    ...
    #region 2. SWAPCostPredictor - SWAP 成本自适应预测

    /// <summary>
    /// 学习在特定硬件拓扑上的 SWAP 成本
    /// 根据 qubit 距离和当前配置动态调整
    /// </summary>
    public class SWAPCostPredictor
    {
        ...
        /// <summary>
        /// 预测源 qubit 到目标 qubit 的 SWAP 成本倍数
    ...
    public class ResourcePredictor
    {
        ...
        private float _tGateToTimeRatio = 0.05f;     // T 门 -> 执行时间
